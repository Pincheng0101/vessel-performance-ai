...
import AthenaParameters from './AthenaParameters';

class AthenaStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {AthenaParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.ATHENA.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.ATHENA.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.ATHENA.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new AthenaParameters(parameters);
  }
}

export default AthenaStateDefinition;
