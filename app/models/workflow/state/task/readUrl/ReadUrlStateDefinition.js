...
import ReadUrlParameters from './ReadUrlParameters';

class ReadUrlStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {ReadUrlParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.READ_URL.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.READ_URL.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.READ_URL.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new ReadUrlParameters(parameters);
  }
}

export default ReadUrlStateDefinition;
