...
class BedrockAnthropicLlm extends Llm {
  constructor({
    accountId,
    awsAccessKeyId,
    awsSecretAccessKey,
  ...
  get displayFields() {
    ...
    const displayFields = [
      ...
      { title: $i18n.t('__fieldEnableThinking'), value: this.enableThinking ? $i18n.t('__fieldYes') : $i18n.t('__fieldNo'), isChip: true, chipOptions: { color: this.enableThinking ? 'success' : null } },
      ...
      { title: $i18n.t('__fieldThinkingBudgetTokens'), value: numUtils.format(this.thinkingBudgetTokens) },
      { title: $i18n.t('__fieldThinkingEffort'), value: this.effort ? $i18n.t(findField(LlmConstant.ThinkingEffort, this.effort, 'i18nTitle')) : null },
  ...
  /**
   * @param {BedrockAnthropicLlm} resource
   */
  static toRequestPayload(resource) {
    const payload = {
      ...super.toRequestPayload(resource),
      enable_thinking: resource.enableThinking,
...
export default BedrockAnthropicLlm;
