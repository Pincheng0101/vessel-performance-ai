...
class AmazonRanker extends Ranker {
  constructor({
    modelId,
    rankerId,
    rankerName,
    ...
    this.modelId = modelId ?? RankerConstant.AmazonModel.AMAZON_RERANK_V1.value;
    this.region = region ?? '';
  }
  ...
  get displayFields() {
    ...
    return [
      ...
      { title: $i18n.t('__fieldModel'), value: findField(RankerConstant.AmazonModel, this.modelId, 'title') },
