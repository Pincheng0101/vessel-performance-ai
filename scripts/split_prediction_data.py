...
def main() -> None:
    ...
    parser.add_argument("--output-dir", default="tmp/yangming-aws-summit-hackathon", help="Directory for the split CSV files")
    parser.add_argument("--test-size", type=float, default=0.2, help="Fraction of rows per ship class to put into the test set")
