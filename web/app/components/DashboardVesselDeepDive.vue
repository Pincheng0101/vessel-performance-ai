...
// DashboardVesselDeepDiveDetail is keyed by shipId, so picking a different ship (from the
...
// and swap to the loading screen explicitly instead of relying on that behavior.
