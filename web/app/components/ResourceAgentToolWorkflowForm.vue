...
state.formData.trackToolResults ??= AgentConstant.ToolType.WORKFLOW.defaultTrackToolResults;
...
<template>
  <AppForm
    :form-title="$t('__titleModifyToolItem', { action: props.item ? $t('__actionEdit') : $t('__actionAdd'), item: $t('__fieldWorkflow') })"
    :on-submit="submit"
  ...
  >
    <template #body>
      ...
      <ResourceWorkflowPaginatedSelect
        v-model="state.formData.workflowId"
        :return-object="false"
