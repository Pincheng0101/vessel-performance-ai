...
state.formData.trackToolResults ??= AgentConstant.ToolType.HTTP_CLIENT.defaultTrackToolResults;
...
<template>
  <AppForm
    :form-title="$t('__titleModifyToolItem', { action: props.item ? $t('__actionEdit') : $t('__actionAdd'), item: $t('__fieldHttp') })"
    :on-submit="submit"
