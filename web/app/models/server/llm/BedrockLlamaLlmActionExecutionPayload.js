...
class BedrockLlamaLlmActionExecutionPayload extends LlmActionExecutionPayload {
  constructor({
    content,
    guardrailId,
    guardrailVersion,
  ...
  /**
   * @param {BedrockLlamaLlmActionExecutionPayload} llm
   */
...
export default BedrockLlamaLlmActionExecutionPayload;
