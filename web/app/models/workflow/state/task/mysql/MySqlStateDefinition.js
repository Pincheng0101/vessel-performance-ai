...
import MySqlParameters from './MySqlParameters';

class MySqlStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {MySqlParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.MYSQL.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.MYSQL.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.MYSQL.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new MySqlParameters(parameters);
  }
}

export default MySqlStateDefinition;
