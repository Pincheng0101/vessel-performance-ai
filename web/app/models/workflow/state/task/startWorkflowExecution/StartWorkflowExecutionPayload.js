import { StartWorkflowExecutionConstant, StateConstant } from '~/constants';
...
import StartWorkflowExecutionDefaultOutput from './StartWorkflowExecutionDefaultOutput';

class StartWorkflowExecutionPayload extends TaskPayload {
  actionType = StateConstant.ActionType.START_WORKFLOW_EXECUTION.value;
   ...
   * @param {StartWorkflowExecutionDefaultOutput} params.defaultOutput
  ...
  constructor({
    ...
    super({
      defaultOutput: (() => {
        ...
        return new StartWorkflowExecutionDefaultOutput(defaultOutput);
      })(),
      stateMemoryOutputSelector,
      streamingConfig,
      useExternalMemoryOutput,
    });
    this.input = input ?? StartWorkflowExecutionConstant.ActionExecutionParams.INPUT;
  ...
  /**
   * @param {StartWorkflowExecutionPayload} actionPayload
   */
  ...
  static createFromAsl(asl) {
    ...
    return new StartWorkflowExecutionPayload({
...
export default StartWorkflowExecutionPayload;
