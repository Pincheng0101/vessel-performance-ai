...
import McpParameters from './McpParameters';

class McpStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {McpParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.MCP.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.MCP.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.MCP.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new McpParameters(parameters);
  }
}

export default McpStateDefinition;
