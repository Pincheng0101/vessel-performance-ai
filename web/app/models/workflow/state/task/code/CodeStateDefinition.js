...
import CodeParameters from './CodeParameters';

class CodeStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {CodeParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.CODE.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.CODE.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.CODE.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new CodeParameters(parameters);
  }
}

export default CodeStateDefinition;
