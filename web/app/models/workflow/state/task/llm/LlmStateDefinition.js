...
class LlmStateDefinition extends TaskStateDefinition {
  /**
   * @param {Object} params
   * @param {TaskInputOutput} params.inputOutput
   * @param {LlmParameters} params.parameters
   */
  constructor({
    comment,
    end,
    ...
    const defaultInputOutput = {
      inputPath: StateConstant.ActionType.LLM.defaultInputOutput.inputPath,
      resultSelector: StateConstant.ActionType.LLM.defaultInputOutput.resultSelector,
      resultPath: `${StateConstant.DefaultResultPathPrefix}${name}${StateConstant.DefaultResultPathSuffix}`,
      outputPath: StateConstant.ActionType.LLM.defaultInputOutput.outputPath,
    };
    super({
      comment,
      end,
    ...
    this.parameters = new LlmParameters(parameters);
  }
}

export default LlmStateDefinition;
