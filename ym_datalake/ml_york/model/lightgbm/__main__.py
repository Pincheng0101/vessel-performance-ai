"""CLI: run the lightgbm model through the eval harness, or rank its feature importance.

    python -m ym_datalake.ml_york.model.lightgbm evaluate \
        --features etl/vt_fd_features.csv --manifest etl/feature_manifest.json --out-dir etl/eval/lightgbm
    python -m ym_datalake.ml_york.model.lightgbm importance \
...
from ym_datalake.ml_york.model.lightgbm import model
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog='python -m ym_datalake.ml_york.model.lightgbm', description=__doc__)
    ...
    ev.add_argument('--out-dir', default='etl/eval/lightgbm', help='root output dir; one subfolder per fold')
