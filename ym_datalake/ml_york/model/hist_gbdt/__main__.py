"""CLI: run the hist_gbdt model through the eval harness, or rank its feature importance.

    python -m ym_datalake.ml_york.model.hist_gbdt evaluate \
        --features etl/vt_fd_features.csv --manifest etl/feature_manifest.json --out-dir etl/eval/hist_gbdt
    python -m ym_datalake.ml_york.model.hist_gbdt importance \
...
from ym_datalake.ml_york.model.hist_gbdt import model
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog='python -m ym_datalake.ml_york.model.hist_gbdt', description=__doc__)
    ...
    ev.add_argument('--out-dir', default='etl/eval/hist_gbdt', help='root output dir; one subfolder per fold')
