"""CLI: run the elasticnet model through the eval harness, or rank its feature importance.

    python -m ym_datalake.ml_york.model.elasticnet evaluate \
        --features etl/vt_fd_features.csv --manifest etl/feature_manifest.json --out-dir etl/eval/elasticnet
    python -m ym_datalake.ml_york.model.elasticnet importance \
...
from ym_datalake.ml_york.model.elasticnet import model
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog='python -m ym_datalake.ml_york.model.elasticnet', description=__doc__)
    ...
    ev.add_argument('--out-dir', default='etl/eval/elasticnet', help='root output dir; one subfolder per fold')
