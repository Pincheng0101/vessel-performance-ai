"""``model.extra_trees`` — ExtraTrees (extremely randomized trees) comparison model, benchmarked against the XGBoost submission.
...
:mod:`model.extra_trees.model` and the shared :mod:`model.common`.
"""

from ym_datalake.ml_york.model.extra_trees.model import (
    native_importance,
    run_evaluate,
    run_importance,
    train_model,
