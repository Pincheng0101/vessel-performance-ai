"""CLI: run the extra_trees model through the eval harness, or rank its feature importance.

    python -m ym_datalake.ml_york.model.extra_trees evaluate \
        --features etl/vt_fd_features.csv --manifest etl/feature_manifest.json --out-dir etl/eval/extra_trees
    python -m ym_datalake.ml_york.model.extra_trees importance \
...
from ym_datalake.ml_york.model.extra_trees import model
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(prog='python -m ym_datalake.ml_york.model.extra_trees', description=__doc__)
    ...
    ev.add_argument('--out-dir', default='etl/eval/extra_trees', help='root output dir; one subfolder per fold')
